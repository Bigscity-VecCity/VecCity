...
# python run_model.py --task region_representation --model HREP --dataset xa  --gpu_id 0 --config dim128_region --exp_id HREPR --abl recon
...
# do
python run_model.py --task region_representation --model $1 --dataset xa  --gpu_id $2 --config dim128_region --exp_id 16 --choice 10 --train false
# done
